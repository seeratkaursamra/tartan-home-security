...
set CLASSPATH=%APP_HOME%\lib\tartan-1.0-SNAPSHOT.jar

@rem Execute tartan
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TARTAN_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%TARTAN_EXIT_CONSOLE%" exit 1
exit /b 1
